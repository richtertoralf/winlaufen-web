...
public final class WinLaufenClient implements AutoCloseable {
    ...
    public WinLaufenClient(String host, StateStore store) { this.host = host; this.store = store; }
    ...
    private void consumeConnection(String targetHost) throws Exception {
        ...
        socket = connection;
        connection.connect(new InetSocketAddress(targetHost, AppConfig.WINLAUFEN_PORT), 5_000);
